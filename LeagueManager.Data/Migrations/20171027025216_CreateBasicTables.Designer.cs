...
namespace LeagueManager.Data.Migrations
{
    ...
    [Migration("20171027025216_CreateBasicTables")]
    partial class CreateBasicTables
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("LeagueManager.Web.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LeagueManager.Web.Models.ApplicationUser")
                        .WithMany("Claims")
